using AcmeProducts.Application;
using AcmeProducts.Application.Interfaces;
using AcmeProducts.Infrastructure.FileManager;
using AcmeProducts.Infrastructure.FileManager.Contexts;
using AcmeProducts.Infrastructure.Identity;
using AcmeProducts.Infrastructure.Identity.Contexts;
using AcmeProducts.Infrastructure.Identity.Models;
using AcmeProducts.Infrastructure.Identity.Seeds;
using AcmeProducts.Infrastructure.Persistence;
using AcmeProducts.Infrastructure.Persistence.Contexts;
using AcmeProducts.Infrastructure.Resources;
using AcmeProducts.WebApi.Infrastracture.Extensions;
using AcmeProducts.WebApi.Infrastracture.Middlewares;
using AcmeProducts.WebApi.Infrastracture.Services;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AcmeProducts.WebApi v1"));
}
